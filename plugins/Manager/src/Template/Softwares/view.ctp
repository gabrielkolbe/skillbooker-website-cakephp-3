...
<BR>
<div class="col-md-8">
    <h1 style="margin:15px 0px 15px 15px;"><?php echo $software->name; ?></h1>
</div>
<div class="col-md-3">
...
<?php } else { ?>
<img src="/img/software/postcard_<?= $software->theimage ?>" alt="<?= $software->name ?>" class="img-rounded margin5 floatleft" style="margin-right:20px; margin-bottom:30px; width:320px; border:1px solid #ccc;">
<?php } ?>
