...
<div class="row">
	<div class="col-md-12">
<?= $this->Html->link(__('Sync User Skills'), ['action' => 'syncdistinctuserkills'], ['class' => 'btn btn-primary']) ?><BR>
...
<?= $this->Html->link(__('Sync Questions Distinct'), ['action' => 'syncdistinctquestionkills'], ['class' => 'btn btn-primary']) ?><BR>
...
<?= $this->Html->link(__('RSS Questions'), ['action' => 'rssquestionsxml'], ['class' => 'btn btn-primary']) ?><BR>
