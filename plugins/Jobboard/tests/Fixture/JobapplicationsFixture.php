<?php
namespace Jobboard\Test\Fixture;
...
class JobapplicationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'applicationstatus_id' => ['type' => 'integer', 'length' => 3, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
