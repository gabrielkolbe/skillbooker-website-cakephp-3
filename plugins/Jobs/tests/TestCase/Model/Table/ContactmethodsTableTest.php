...
use Jobs\Model\Table\ContactmethodsTable;

/**
 * Jobs\Model\Table\ContactmethodsTable Test Case
 */
class ContactmethodsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \Jobs\Model\Table\ContactmethodsTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Contactmethods') ? [] : ['className' => 'Jobs\Model\Table\ContactmethodsTable'];
        $this->Contactmethods = TableRegistry::get('Contactmethods', $config);
    }
