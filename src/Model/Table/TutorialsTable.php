 ...
 *
 * @method \App\Model\Entity\Tutorial get($primaryKey, $options = [])
 * @method \App\Model\Entity\Tutorial newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Tutorial[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Tutorial|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Tutorial patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Tutorial[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\Tutorial findOrCreate($search, callable $callback = null, $options = [])
 *
